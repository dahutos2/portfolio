...
6. 既存PRのhead・CI・レビュー・マージ・公開状態に変化があれば[承認後の作業](delivery.md)の該当段階へ進む。掲載案または本人への確認事項があれば[更新提案](proposals.md)へ進む。新規提案・重要な変化・失敗・利用者判断が必要な場合のみ通知する。同じ保留・承認待ち・却下済みを根拠変化なしに再通知しない。
